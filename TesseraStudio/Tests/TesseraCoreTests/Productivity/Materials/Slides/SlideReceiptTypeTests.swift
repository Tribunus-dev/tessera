...
final class SlideReceiptTypeTests: XCTestCase {
    ...
    func testReceiptValuesAreStable() {
        ...
        XCTAssertEqual(SlideReceiptType.defineMasterPage.rawValue, "slide_master_page_defined")
        XCTAssertEqual(SlideReceiptType.undefineMasterPage.rawValue, "slide_master_page_undefined")
        XCTAssertEqual(SlideReceiptType.setSlideMasterPage.rawValue, "slide_master_page_assigned")
