...
public final class TesseraToolRegistry: Sendable {
    ...
    public static let `default` = TesseraToolRegistry(tools: [
        ...
        SheetStatMedianTool(),
        SheetStatModeTool(),
        SheetStatStandardDeviationTool(),
        SheetStatStandardDeviationPopulationTool(),
        SheetStatVarianceTool(),
        SheetStatVariancePopulationTool(),
        SheetStatRangeTool(),
        SheetStatQuartilesTool(),
        SheetStatIQRTool(),
        SheetStatCorrelationTool(),
        SheetStatLinearRegressionTool(),
        SheetStatRankTool(),
        SheetStatPercentileTool(),
        SheetStatZScoreTool(),
        SheetStatLargeTool(),
        SheetStatSmallTool(),
        SheetStatCountTool(),
