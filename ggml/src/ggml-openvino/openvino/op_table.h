...
GGML_OP_CONVERTER(translate_tile640_matmul);
GGML_OP_CONVERTER(translate_tile640_matmul_id);
GGML_OP_CONVERTER(translate_tile640_get_rows);
GGML_OP_CONVERTER(translate_tile640_dequant);
GGML_OP_CONVERTER(translate_tile512_matmul);
GGML_OP_CONVERTER(translate_tile512_matmul_id);
GGML_OP_CONVERTER(translate_tile512_get_rows);
GGML_OP_CONVERTER(translate_tile512_dequant);
GGML_OP_CONVERTER(translate_tile1024_matmul);
GGML_OP_CONVERTER(translate_tile1024_matmul_id);
GGML_OP_CONVERTER(translate_tile1024_get_rows);
GGML_OP_CONVERTER(translate_tile1024_dequant);
