...
std::unordered_map<std::string, CreatorFunction> get_supported_ops() {
    ...
    return {
        ...
        {"GGML_OP_TILE640_MATMUL",  op::translate_tile640_matmul                   },
        {"GGML_OP_TILE640_MATMUL_ID", op::translate_tile640_matmul_id              },
        {"GGML_OP_TILE640_GET_ROWS", op::translate_tile640_get_rows                },
        {"GGML_OP_TILE640_DEQUANT", op::translate_tile640_dequant                  },
        {"GGML_OP_TILE512_MATMUL",  op::translate_tile512_matmul                   },
        {"GGML_OP_TILE512_MATMUL_ID", op::translate_tile512_matmul_id              },
        {"GGML_OP_TILE512_GET_ROWS", op::translate_tile512_get_rows                },
        {"GGML_OP_TILE512_DEQUANT", op::translate_tile512_dequant                  },
        {"GGML_OP_TILE1024_MATMUL",  op::translate_tile1024_matmul                   },
        {"GGML_OP_TILE1024_MATMUL_ID", op::translate_tile1024_matmul_id              },
        {"GGML_OP_TILE1024_GET_ROWS", op::translate_tile1024_get_rows                },
        {"GGML_OP_TILE1024_DEQUANT", op::translate_tile1024_dequant                  },
