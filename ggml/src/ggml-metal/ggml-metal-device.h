...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_tile640_matmul_interleaved(ggml_metal_library_t lib, const struct ggml_tensor * op);
