...
class MODEL_ARCH(IntEnum):
    ...
    GRANITE_HYBRID   = auto()
    GRANITE4VISION   = auto()
    GRANITE_DOCLING  = auto()
    GRANITE_SPEECH_PLUS = auto()
    CHAMELEON        = auto()
...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.GRANITE4VISION:    "granite4vision",
    MODEL_ARCH.GRANITE_DOCLING:   "granite-docling",
    MODEL_ARCH.GRANITE_SPEECH_PLUS: "granite-speech-plus",
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    # Granite4Vision text decoder: same dense Llama tensors as GRANITE.
    MODEL_ARCH.GRANITE4VISION: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
    ...
    # Granite Docling text decoder: same dense Llama tensors as GRANITE.
    MODEL_ARCH.GRANITE_DOCLING: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
    ...
    # Granite Speech Plus text decoder: same dense Llama tensors as GRANITE.
    MODEL_ARCH.GRANITE_SPEECH_PLUS: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
        MODEL_TENSOR.OUTPUT,
        MODEL_TENSOR.ATTN_NORM,
    ...
    MODEL_ARCH.QWEN3_TTS_CODE2WAV: [
        MODEL_TENSOR.C2W_CODEBOOK_EMBD,
        MODEL_TENSOR.C2W_VQ_FIRST_PROJ,
        MODEL_TENSOR.C2W_VQ_REST_PROJ,
        MODEL_TENSOR.C2W_PRE_CONV,
        MODEL_TENSOR.C2W_TF_IN_PROJ,
        MODEL_TENSOR.C2W_TF_ATTN_NORM,
        MODEL_TENSOR.C2W_TF_ATTN_Q,
        MODEL_TENSOR.C2W_TF_ATTN_K,
        MODEL_TENSOR.C2W_TF_ATTN_V,
        MODEL_TENSOR.C2W_TF_ATTN_O,
        MODEL_TENSOR.C2W_TF_ATTN_SCALE,
        MODEL_TENSOR.C2W_TF_FFN_NORM,
        MODEL_TENSOR.C2W_TF_FFN_GATE,
        MODEL_TENSOR.C2W_TF_FFN_UP,
        MODEL_TENSOR.C2W_TF_FFN_DOWN,
        MODEL_TENSOR.C2W_TF_FFN_SCALE,
        MODEL_TENSOR.C2W_TF_NORM,
        MODEL_TENSOR.C2W_TF_OUT_PROJ,
        MODEL_TENSOR.C2W_UP_TRANSCONV,
        MODEL_TENSOR.C2W_UP_DWCONV,
        MODEL_TENSOR.C2W_UP_NORM,
        MODEL_TENSOR.C2W_UP_PW1,
        MODEL_TENSOR.C2W_UP_PW2,
        MODEL_TENSOR.C2W_UP_GAMMA,
        MODEL_TENSOR.C2W_STEM,
        MODEL_TENSOR.C2W_BLOCK_SNAKE_A,
        MODEL_TENSOR.C2W_BLOCK_SNAKE_B,
        MODEL_TENSOR.C2W_BLOCK_TRANSCONV,
        MODEL_TENSOR.C2W_RES_SNAKE1_A,
        MODEL_TENSOR.C2W_RES_SNAKE1_B,
        MODEL_TENSOR.C2W_RES_CONV1,
        MODEL_TENSOR.C2W_RES_SNAKE2_A,
        MODEL_TENSOR.C2W_RES_SNAKE2_B,
        MODEL_TENSOR.C2W_RES_CONV2,
        MODEL_TENSOR.C2W_OUT_SNAKE_A,
        MODEL_TENSOR.C2W_OUT_SNAKE_B,
        MODEL_TENSOR.C2W_OUTPUT,
    ],
    MODEL_ARCH.MISTRAL4: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
