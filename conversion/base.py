...
def get_model_architecture(hparams: dict[str, Any], model_type: ModelType) -> str:
    ...
    if model_type == ModelType.TEXT and arch in ("StepVLForConditionalGeneration", "Sarashina2VisionForCausalLM", "Exaone4_5_ForConditionalGeneration", "Step3p7ForConditionalGeneration", "Granite4VisionForConditionalGeneration", "Idefics3ForConditionalGeneration", "GraniteSpeechPlusForConditionalGeneration"):
        return arch
